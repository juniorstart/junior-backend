        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateOfCompanyReply = table.Column<DateTime>(nullable: true),
                    CompanyReply = table.Column<bool>(nullable: false),
                    Notes = table.Column<string>(nullable: true),
                    LinkToApplication = table.Column<string>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecruitmentInformations", x => x.RecruitmentId);
                    table.ForeignKey(
                        name: "FK_RecruitmentInformations_Users_OwnerId",
                        column: x => x.OwnerId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecruitmentInformations_OwnerId",
                table: "RecruitmentInformations",
                column: "OwnerId");
